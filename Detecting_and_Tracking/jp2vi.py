...
output_dir = 'I:\\codes\\keras-yolov3-KF-objectTracking-master\\camdetec4'
output_path = os.path.join(output_dir, '')  # 输入图片存放位置
output_video_file = 'I:\\codes\\keras-yolov3-KF-objectTracking-master\\jpg2video\\camera4_fps5.mp4'  # 输入视频保存位置以及视频名称
save_to_video(output_path, output_video_file,5)
