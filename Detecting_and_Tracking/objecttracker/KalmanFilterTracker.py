...
class Tracker(object):
    ...
    def Update(self, detections):
        ...
        # Create tracks if no tracks vector found
        #print('Now updating...creating tracks if no tracks vetor found')
        ...
        # to predicted tracks
        #print('Using Hungarian Algorithm assign the correct detected measurements to predicted tracks')
        assignment = []
        for _ in range(N):
            assignment.append(-1)
        ...
        # Now look for un_assigned detects
      #  print('Now look for un_assigned detects')
        un_assigned_detects = []
        for i in range(len(detections)):
      ...
      #  print('Start new tracks')
        ...
        # Update KalmanFilter state, lastResults and tracks trace
       # print('Update KalmanFilter state, lastResults and tracks trace')
        for i in range(len(assignment)):
